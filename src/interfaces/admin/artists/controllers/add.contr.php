...
$sql = "INSERT INTO artiste (prenom, nom, pseudo, email, telephone, web, facebook, instagram, adresse, ville, code_postal, domaine, presentation, description, photo_url, interview_url, genre_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?);";
$stmt = $db->prepare($sql);
